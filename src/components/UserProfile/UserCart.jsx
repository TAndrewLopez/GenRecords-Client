...
const adjustQty = (addOrSub) => {
  if (addOrSub) {
    return (
      <button className="px-2 bg-shade-7 opacity-50 hover:opacity-100 hover:bg-accent ease-in-out duration-300 peer">
